...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mMensageError;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMensageError = (TextView) findViewById(R.id.tv_error_message_display);
